...
class App:
    def __init__(self, root):
        ...
        GButton_747["text"] = "Baysian Normal"
        ...
        GButton_13["text"] = "Baysian Fselection fclassif"
        ...
        GButton_678["text"] = "Baysian Standard scaler Fselection fclassif"
        ...
        GButton_643["text"] = "Baysian Standardscaler Fselection mutualclassif"
        GButton_643.place(x=35,y=360,width=250,height=45)
        ...
        GLabel_658["text"] = "Gaussian Naive Bayes"
        GLabel_658.place(x=40,y=10,width=230,height=56)

    def GButton_747_command(self):
        subprocess.run(["python", "Bayesian.py"], check=True)


    def GButton_13_command(self):
        subprocess.run(["python", "Bayesian_fselection_fclassif.py"], check=True)
        


    def GButton_678_command(self):
        subprocess.run(["python", "Bayesian_standardscaler_fselection_fclassif.py"], check=True)


    def GButton_643_command(self):
        subprocess.run(["python", "Bayesian_standardscaler_fselection_mutualclassif.py"], check=True)
